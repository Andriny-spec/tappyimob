      ...
      <div className="flex-1 overflow-y-auto p-6">
        <Form {...form}>
          <form className="space-y-8">
            ...
            <div>
              <h3 className="text-lg font-medium mb-4">Tipificação e Valores</h3>
            ...
            {/* Seção de status */}
            <div>
              <h3 className="text-lg font-medium mb-4">Status do Imóvel</h3>
              <FormField
                control={form.control}
                name="status"
                render={({ field }) => (
                  <FormItem className="space-y-3">
                    <FormLabel>Escolha o status</FormLabel>
                    <FormControl>
                      <RadioGroup
                        onValueChange={field.onChange}
                        defaultValue={field.value}
